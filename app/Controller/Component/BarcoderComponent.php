<?php
class BarcoderComponent extends Object {
...
//                    $encodedString .= "32"; //Stop 
        ...
        $this->IH = imagecreate($this->WIDTH, $this->HEIGHT+20)
            ...
            { 
              ...
              default : 
                if ($text != ''){
                    ...
                    imagestring($this->IH, 1,  intval((($this->WIDTH)-(imagefontwidth(1) * (strlen($str1)>28?28:strlen($str1))))/2)+1, $this->HEIGHT - imagefontheight(1)+9, utf8_decode((strlen($str1)>28? substr($str1,0,25)."...":$str1)), $color[1]); 
                    imagestring($this->IH, 1,  intval((($this->WIDTH)-(imagefontwidth(1) * strlen($str2)))/2)+1, $this->HEIGHT - imagefontheight(1)+18, utf8_decode(substr($str2,0,25)), $color[1]); 
                }
            } 
